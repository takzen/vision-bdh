...
def main(args):
    ...
    CHECKPOINT_DIR = "./checkpoints_v1_cifar10"
    LOG_FILE = os.path.join(CHECKPOINT_DIR, "metrics_v1_cifar10.csv")
    MLP_MULTIPLIER = 32
    ...
    print("=" * 70)
    print(f"     Training Vision-BDH v1 (MLP Multiplier = 32, {EPOCHS} Epochs)")
    print("=" * 70)
    ...
    if start_epoch == 0 and not os.path.exists(LOG_FILE):
